            ...
            <div class="mb-3">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="name-en-tab">
                        <input type="text" class="form-control @error('name_en') is-invalid @enderror" id="name_en" name="name_en" value="{{ old('name_en', $item->name_en ?: $item->name) }}" maxlength="255" placeholder="Product name in English">
                        @error('name_en')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
                    </div>
                    <div class="tab-pane fade" id="name-ar-tab">
                        <input type="text" class="form-control @error('name_ar') is-invalid @enderror" id="name_ar" name="name_ar" value="{{ old('name_ar', $item->name_ar) }}" maxlength="255" dir="rtl" placeholder="اسم المنتج بالعربي">
