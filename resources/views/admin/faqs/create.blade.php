...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2 class="mb-1 fw-bold">{{ __('admin.faqs_page.add_new') }}</h2>
        <p class="text-muted mb-0">{{ __('admin.faqs_page.create_subtitle') }}</p>
    </div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="question_en" class="form-control @error('question_en') is-invalid @enderror"
                               value="{{ old('question_en') }}" placeholder="{{ __('admin.faqs_page.placeholder_q_en') }}" required>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="answer_en" class="form-control @error('answer_en') is-invalid @enderror"
                                  rows="5" placeholder="{{ __('admin.faqs_page.placeholder_a_en') }}" required>{{ old('answer_en') }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="question_ar" class="form-control @error('question_ar') is-invalid @enderror"
                               value="{{ old('question_ar') }}" placeholder="{{ __('admin.faqs_page.placeholder_q_ar') }}" dir="rtl" required>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="answer_ar" class="form-control @error('answer_ar') is-invalid @enderror"
                                  rows="5" placeholder="{{ __('admin.faqs_page.placeholder_a_ar') }}" dir="rtl" required>{{ old('answer_ar') }}</textarea>
            ...
            <div class="card border-0 shadow-sm" style="border-radius: 16px;">
                <div class="card-body p-4">
                    ...
                    <div class="form-check form-switch mb-4">
                        ...
                        <div class="form-text">{{ __('admin.faqs_page.publish_hint') }}</div>
                    </div>
                    <button type="submit" class="btn btn-primary w-100"><i class="fas fa-save me-2"></i> {{ __('admin.faqs_page.save') }}</button>
                </div>
            </div>
        </div>
    </div>
