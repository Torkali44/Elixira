                ...
                <div class="border rounded p-3 h-100">
                    ...
                    <div class="mt-2">
                        ...
                        <input type="number" min="0" class="form-control"
                            name="country_prices[{{ $code }}][reward_points]"
                            value="{{ old("country_prices.{$code}.reward_points", $row?->reward_points) }}"
                            placeholder="{{ __('admin.items_page.country_reward_points_placeholder') }}">
                    </div>
                </div>
            </div>
        @endforeach
