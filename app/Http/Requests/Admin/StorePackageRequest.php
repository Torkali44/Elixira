...
class StorePackageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'country_prices.KSA.size_en' => 'nullable|string|max:120',
            'country_prices.KSA.size_ar' => 'nullable|string|max:120',
            'country_prices.KSA.member_price' => 'nullable|numeric|min:0',
            'country_prices.KSA.guest_price' => 'nullable|numeric|min:0',
            'country_prices.KSA.reward_points' => 'nullable|integer|min:0',
            'country_prices.KSA.stock' => 'nullable|integer|min:0',
            'country_prices.UAE' => 'nullable|array',
            'country_prices.UAE.size_en' => 'nullable|string|max:120',
            'country_prices.UAE.size_ar' => 'nullable|string|max:120',
            'country_prices.UAE.member_price' => 'nullable|numeric|min:0',
            'country_prices.UAE.guest_price' => 'nullable|numeric|min:0',
            'country_prices.UAE.reward_points' => 'nullable|integer|min:0',
            'country_prices.UAE.stock' => 'nullable|integer|min:0',
